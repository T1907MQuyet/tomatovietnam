                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <f:input path="product_name" type="text"  class="form-control ${param.errorcatename !=null ?'border border-danger':''}" placeholder="Enter product name"/>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label>Price:</label>
                                    <f:input path="price" step="0.01" type="number" class="form-control " placeholder="Enter price product...."/>
                                </div>
                                <div class="form-group col-md-6">
