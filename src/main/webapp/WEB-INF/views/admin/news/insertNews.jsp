...
<f:form action="${pageContext.request.contextPath}/admin/news/saveNews" method="POST" enctype="multipart/form-data" modelAttribute="newsNew">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-10">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <f:errors path="home_active" class="text-danger"  ></f:errors>
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Service:</label>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <f:errors path="title_content" class="text-danger"  ></f:errors>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <f:errors path="imageLink" class="text-danger" ></f:errors>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
