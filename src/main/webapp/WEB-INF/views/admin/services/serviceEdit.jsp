            ...
            <div class="col-md-5">
                ...
                <div class="card card-info">
                    ...
                    <div class="card-body" style="display: block;">
                        <!-- /.card-header -->
                        <!-- form start -->
                        <%--@elvariable id="serviceEdit" type=""--%>
                        <f:form action="${pageContext.request.contextPath}/admin/service/updateService" method="POST" modelAttribute="serviceEdit">
                                <f:input path="service_id" type="hidden"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <f:textarea path="description" type="text"  class="form-control  ${status.error ?'border border-danger':''} " id="exampleInputEmail1"  placeholder="Enter description..."/>
                                </div>
                                <div class="form-group">
                                    <label>Status:</label>
