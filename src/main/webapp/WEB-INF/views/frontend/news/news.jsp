    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h2 class="text-uppercase wow fadeInDown">News Page</h2>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row wow fadeInUp">
            <aside class="col-md-3">
                ...
                <div class="side-widget">
                    <h5>Categories</h5>
                    <ul class="side-cat">
                        <li><i class="fa fa-chevron-right"></i><a href="${pageContext.request.contextPath}/food/news" style="color:#dead5a">All</a></li>
                        <c:forEach items="${listType}" var="type">
                            <li><i class="fa fa-chevron-right"></i> <a href="${pageContext.request.contextPath}/food/news/type?type_id=${type.type_new_id}">${type.type_name}</a></li>
                ...
                <ul class="pagi_nation">
                    <c:if test="${totalPages > 1}">
                        <c:if test="${currentPage>1}">
                            <li class="page-item"><a class="page-link" href="/food/news/page/${currentPage-1}">«</a></li>
                        </c:if>
                        <c:forEach  end="${totalPages}" begin="1" varStatus="loop">
                            <c:if test="${currentPage != loop.index}">
                                <li class="page-item "><a class="page-link" href="/food/news/page/${loop.index}">${loop.index}</a></li>
                            </c:if>
                            <c:if test="${currentPage == loop.index}">
                                <li class="page-item active"><a class="page-link" href="/food/news/page/${loop.index}">${loop.index}</a></li>
                            </c:if>
                        </c:forEach>
