        ...
        <div class="row">
            <div class="col-md-12">
                <article>
                    ...
                    ${news.title_content}
                    ${news.content}
                    <p>Tất cả các ngày trong dịch vụ: </p>
                        <c:forEach items="${listCalen}" var="calender">
                            <p>-<fmt:formatDate value="${calender.solar_calendar}" pattern="dd/MM/yyyy" />(<span style="font-weight: bold">ÂL:</span> <fmt:formatDate value="${calender.lunar_calendar}" pattern="dd/MM/yyyy" />)<span style="font-weight: bold">.</span> </p>
                        </c:forEach>
                </article>
            </div>
        </div>
