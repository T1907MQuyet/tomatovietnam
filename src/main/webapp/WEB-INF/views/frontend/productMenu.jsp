                        ...
                        <c:forEach var="pro" items="${listProMenuDetail}">
                            <div class="col-md-4 col-sm-6">
                                <div class="product-info">
                                    ...
                                    <h4><a href="${pageContext.request.contextPath}/food/productDetail?proId=${pro.product.product_id}">${pro.product.product_name}
                                    <c:if test="${pro.product.discount > 0}"><span style="font-size: 14px">(-${pro.product.discount}%)</span> </c:if>
                                    </a></h4>
